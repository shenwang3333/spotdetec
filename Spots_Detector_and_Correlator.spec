# PyInstaller spec for English GUI
# Run from project root: pyinstaller Spots_Detector_and_Correlator.spec
...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'gui_en', 'gui_en.main_window_en', 'gui_en.params_en', 'gui_en.results_en', 'gui_en.preview_en',
    ],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
